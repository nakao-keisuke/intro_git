...
import { HTTP_SEND_TEXT_MESSAGE } from '@/constants/endpoints';
...
type UseSendTextMessageReturn = {
  sendTextMessage: (partnerId: string, content: string) => Promise<SendResult>;
  isLoading: boolean;
  error: string | null;
};

export const useSendTextMessage = (): UseSendTextMessageReturn => {
