...
import styles from '@/styles/purchase/InCallSquarePayment.module.css';
 ...
 * Squareのカード決済フォーム
 */
export const InCallSquarePaymentContent = ({
  amount,
  point,
  email,
  userName,
  ...
  const _currentYeahPoint = usePointStore((s) => s.currentPoint);
