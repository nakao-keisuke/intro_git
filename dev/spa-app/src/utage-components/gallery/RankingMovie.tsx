...
import styles from '@/styles/GalleryRanking.module.css';
...
const RankingMoviesGallery: React.FC<MoviesGalleryProps> = ({
  videoRankingList,
}) => {
    ...
    return (
      <li key={user.user_id}>
        ...
        <div
          ...
          style={{
            display: user.isSendRequest ? 'none' : 'inline-block',
          }}
        >
          動画リクエスト
        </div>
...
export default RankingMoviesGallery;
