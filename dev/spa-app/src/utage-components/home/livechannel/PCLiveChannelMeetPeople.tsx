...
const PCLiveChannelMeetPeople = memo(() => {
  ...
  const items = livePeopleInfoList
    ?.filter((item) => item.liveCallView.type === 'live')
          ...
          >
            <div className={styles.set}>
              ...
              <div className={styles.thumbnail}>
                ...
                <Image
                  src={imageUrl(
                    livePeopleInfoList?.[index]?.meetPerson?.avatarId ?? '',
                  )}
                  alt="ユーザー画像"
                  placeholder="empty"
                  quality={100}
...
PCLiveChannelMeetPeople.displayName = 'PCLiveChannelMeetPeople';

export default PCLiveChannelMeetPeople;
