...
const TutoVideochat2Image = '/tuto/tuto_videochat_2.webp';
...
const TUTORIAL_STEPS: StepData[] = [
  {
    ...
    title: '好みの女の子を探そう',
    description:
      '「さがす」から、配信中または配信待機中の女の子をチェック！\n配信中のユーザーがいない場合でも、プロフィールからビデオチャットのリクエストを無料で送信できます。',
    image: {
      src: WomenUserImage,
      alt: 'step1_Pic',
    },
  },
  {
    ...
    title: 'ビデオチャットに入室',
    description:
      '配信中の女の子を見つけたら、すぐに入室可能！\n複数の男性が同時に視聴できるので、みんなでワイワイ楽しめます。',
    image: {
      src: TutoVideochat2Image,
      alt: 'step2_Pic',
    },
  },
  {
    ...
    title: 'チャットで盛り上がろう！',
    description:
      'コメントを送って、女の子とコミュニケーション！\nあなたの顔を映す必要はないので、気軽に参加できます。\n遠隔バイブを送信すればさらに盛り上がること間違いなし！',
    video: {
...
const StepContent: React.FC<{ step: StepData }> = ({ step }) => {
  return (
    <div className="mx-auto w-full max-w-[500px] rounded-[12px] bg-white p-[15px] shadow-[0_2px_8px_rgba(0,0,0,0.1)]">
      <div className="mx-auto mb-[10px] w-fit flex-shrink-0 whitespace-nowrap rounded-[25px] bg-gradient-to-br from-[#a855f7] to-[#ec4899] px-5 py-[10px] font-bold text-[14px] text-white">
        {step.number}
      </div>
  ...
  return (
    <section className="mx-[15px] mt-[30px] mb-[15px] mb-[200px] rounded-[20px] bg-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.1)] backdrop-blur-[20px]">
      ...
      <div className="rounded-[15px] p-5">
        <h1 className="mt-0 mb-[15px] bg-gradient-to-br from-[#a855f7] to-[#ec4899] bg-clip-text text-center font-bold text-[#333] text-[22px] text-transparent">
          ビデオチャットの始め方
        </h1>
        ...
        <div className="relative mx-auto flex w-full max-w-[800px] justify-center py-[15px] md:hidden">
          <div className="relative flex w-full items-center justify-center">
            <button
              ...
              className="z-[1] flex h-[40px] min-h-[40px] w-[40px] min-w-[40px] flex-shrink-0 cursor-pointer items-center justify-center rounded-full border-none bg-gradient-to-br from-[#a855f7] to-[#ec4899] font-bold text-[18px] text-white transition-all duration-300 hover:scale-110"
              aria-label="前のスライドへ"
            >
              ＜
            </button>
      ...
      {/* チャット機能の特長 */}
      <h2 className="mb-[30px] bg-gradient-to-br from-[#a855f7] to-[#ec4899] bg-clip-text text-center font-bold text-[24px] text-transparent">
        ビデオチャットの楽しみ方
      </h2>

      <div className="grid grid-cols-1 gap-[25px] px-5 max-w-[768px]:gap-5 min-[250px]:grid-cols-2">
        <div className="rounded-[12px] border-2 border-transparent bg-white p-[25px] text-center shadow-[0_4px_15px_rgba(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-[5px] hover:border-[#ec4899] hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)]">
          <div className="mb-[15px] block text-[48px]">💬</div>
          <h3 className="mb-[10px] font-bold text-[#333] text-[18px]">
            チャットでコミュニケーション
          </h3>
          <p className="m-0 text-[#666] text-[14px] leading-[1.6]">
            コメントを送って配信を盛り上げよう！女の子の反応を楽しめます。
          </p>
        </div>
        ...
        <div className="rounded-[12px] border-2 border-transparent bg-white p-[25px] text-center shadow-[0_4px_15px_rgba(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-[5px] hover:border-[#ec4899] hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)]">
          ...
          <p className="m-0 text-[#666] text-[14px] leading-[1.6]">
            ギフトを送って女の子を応援！特別なリアクションがもらえるかも。
          </p>
        </div>
      </div>
